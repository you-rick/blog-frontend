    ...
    <footer className={s.mainFooter}>
      <Container maxWidth="lg">
        <Grid container spacing={5}>
          <Grid item md={4}>
            <Typography variant="h6" component="h2" gutterBottom>Discover Small</Typography>
          ...
          <Grid item md={4}>
            <Typography variant="h6" component="h2" gutterBottom>Make Small yours</Typography>
            <Typography variant="body2" component="p">
          ...
          <Grid item md={4}>
            <Typography variant="h6" component="h2" gutterBottom>Become a member</Typography>
            <Typography variant="body2" component="p">
