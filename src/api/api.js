...
export const articlesAPI = {
  getArticles(currentPage = 1, pageSize = 10, author = '', category = '', best = 0, likedBy = '', savedBy = '') {
    const query = `page=${currentPage}&limit=${pageSize}&author=${author}&category=${category}&best=${best}&likedBy=${likedBy}&savedBy=${savedBy}`;
